...
import 'beritayangdisukai_item_model.dart';

/// This class defines the variables used in the [berita_yang_di_sukai_page],
/// and is typically used to hold data that is passed between different parts of the application.
class BeritaYangDiSukaiModel {
  Rx<List<BeritayangdisukaiItemModel>> beritayangdisukaiItemList = Rx([
    BeritayangdisukaiItemModel(
        politik: "Politik".obs,
        elonMuskMemaksa:
