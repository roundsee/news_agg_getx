...
class UkuranTextScreen extends GetWidget<UkuranTextController> {
  const UkuranTextScreen({Key? key}) : super(key: key);
            ...
            body: Container(
                ...
                child: SizedBox(
                    ...
                    child: Column(
                        ...
                        children: [Spacer(), _buildUkuranTextColumn()])))));
  }

  /// Section Widget
  Widget _buildUkuranTextColumn() {
    return Container(
        width: double.maxFinite,
            ...
            children: [
              ...
              Padding(
                  ...
                  child: Row(children: [
                    ...
                    Padding(
                        padding:
                            EdgeInsets.only(left: 10.h, top: 3.v, bottom: 3.v),
                        child: Text("lbl_besar".tr,
                            style: theme.textTheme.titleSmall))
                  ])),
