...
import 'blokircomment_item_model.dart';

/// This class defines the variables used in the [blokir_comment_screen],
/// and is typically used to hold data that is passed between different parts of the application.
class BlokirCommentModel {
  Rx<List<BlokircommentItemModel>> blokircommentItemList = Rx([
    BlokircommentItemModel(
        oneHundred: "100".obs,
        oneHundred1: "100".obs,
        oneHundred2: "100".obs,
        politik: "Politik".obs,
