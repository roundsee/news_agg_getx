...
class CustomSearchView extends StatelessWidget {
  ...
  Widget get searchViewWidget => SizedBox(
        ...
        child: TextFormField(
          ...
          autofocus: autofocus!,
          style: textStyle ?? CustomTextStyles.bodySmallBluegray700,
  ...
  InputDecoration get decoration => InputDecoration(
        hintText: hintText ?? "",
        hintStyle: hintStyle ?? CustomTextStyles.bodySmallBluegray700,
        prefixIcon: prefix ??
            Container(
        ...
        suffixIcon: suffix ??
            Container(
              margin: EdgeInsets.fromLTRB(30.h, 6.v, 7.h, 6.v),
              child: CustomImageView(
